		...
		<div class="sign-up-container">
			...
			<div class="">
				<form name="sign-up" action="" method="post" onsubmit="return signupValidation()">
					<div class="signup-heading">Registro de Usuario</div>
					<?php
					...
					<div class="row">
						<div class="inline-block">
							<div class="form-label">
								Correo<span class="required error" id="email-info"></span>
							</div>
					...
					<div class="row">
						<div class="inline-block">
							<div class="form-label">
								Confirmar Contraseña<span class="required error" id="confirm-password-info"></span>
							</div>
							<input class="input-box-330" type="password" name="confirm-password" id="confirm-password">
						</div>
					</div>
					<div class="row">
						<input class="btn" type="submit" name="signup-btn" id="signup-btn" value="Registro de Usuario">
					</div>
				</form>
			</div>
		</div>
